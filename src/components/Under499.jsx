...
const Under499 = () => {
  ...
  const under499Products = products.filter(p => p.id >= 19 && p.id <= 22);

  return (
    <div className="bg-gray-100 w-full pb-8">
      <div className="flex justify-between px-9 sm:px-10 md:px-22 py-9">
        <div className="flex gap-6 items-center">
          ...
          <div>
            <h3 className="font-semibold text-2xl text-black">Under ₹499</h3>
