...
const Under99 = () => {
  ...
  // Filter id: 11 to 14 products
  const under99Products = products.filter(p => p.id >= 11 && p.id <= 14);

  return (
    <div className="bg-green-100 w-full pb-8 ">
      ...
      <div className="flex justify-between px-9 sm:px-10 md:px-22 py-9">
        <div className="flex gap-6 items-center">
          ...
          <div>
            <h3 className="font-semibold text-2xl text-black">Under ₹99</h3>
            <p className="text-xl text-gray-600">Grab now before it's gone</p>
          </div>
        </div>
